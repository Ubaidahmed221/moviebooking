...
@section('content')
 <h2 class="text-center mt-5">Movie Trash List</h2>
 <div class="container-fluid mt-5">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a href="{{ url('/dashboards/movie/restore') }}/{{ $item->mid }}" class="btn btn-primary">Restore</a>
                <a href="{{ url('/dashboards/movie/forcedelet') }}/{{ $item->mcid }}" class="btn btn-danger">Delect</a>
           {{-- <a  onclick="myinfo({{$item->mid}})" class="btn btn-danger">Delect</a>  --}}
            </td>
        </tr>
        @endforeach
...
<script>
    ...
    //         window.location.href = "/dashboards/movie/forcedelet/" + id;
